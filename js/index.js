...
var S = {
    init: function() {
        ...
        if (i !== -1) {
            ...
            S.UI.simulate('#rectangle|#countdown 5|The Day is|#Date|The Time Is|#time|黄晶丽|圣诞快乐!|Best Wishes!|#author||');
        }
    ...
    function performAction(value) {
        ...
        timedAction(function(index) {
            ...
            switch (action) {
                ...
                case 'author':
                    S.Shape.switchShape(S.ShapeBuilder.letter('来自杨正谦'));
                    break;
                default:
                    S.Shape.switchShape(S.ShapeBuilder.letter(current[0] === cmd ? '杨正谦' : current));
            }
